...
CONFIG_DESCRIPTIONS = {
    ...
    "datahub": "DataHub caregiver/employee database with comprehensive employee data.",
    "skills": "Skills database with employee skills, capabilities, and proficiencies.",
    "employee_analytics": "Combined employee and skills analytics with automatic routing between datahub and skills agents.",
}
...
CONFIG_ICONS = {
    ...
    "datahub": "https://img.icons8.com/fluency/96/people.png",
    "skills": "https://img.icons8.com/fluency/96/graduation-cap.png",
    "employee_analytics": "https://img.icons8.com/fluency/96/business-report.png",
}
...
async def on_message(message: cl.Message):
    ...
    try:
        ...
        # Only display visualization image if it was generated for this specific query
        if visualization_image and isinstance(visualization_image, str) and len(visualization_image) > 0:
            try:
