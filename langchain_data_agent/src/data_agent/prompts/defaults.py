...
## Available Data
The variable `data` contains the query results as a list of dictionaries.
DO NOT parse strings or use ast.literal_eval(). The data is already in the correct format.
Simply use the `data` variable directly in your code.

Example:
```python
import matplotlib.pyplot as plt

# data is already available as a list of dicts
