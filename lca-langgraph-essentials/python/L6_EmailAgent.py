"""
LangGraph Essentials - Build An Email Agent Workflow

This script implements an email processing workflow that:
- Classifies incoming emails by intent and urgency
- Searches documentation for relevant information
- Creates bug tracking tickets when needed
- Generates draft responses
- Routes to human review based on urgency
...
from azure_openai_utils import get_azure_chat_model
...
def test_multiple_emails():
    """Test with multiple email scenarios"""
    app = build_email_agent()
    ...
    print(f"\n\nEmails needing approval: {len(needs_approval)}")
...
if __name__ == "__main__":
    print("=" * 80)
    print("Email Agent Workflow - LangGraph Essentials")
    print("=" * 80)
    print()
    
    # Test 1: Single urgent billing issue
    print("Test 1: Urgent Billing Issue")
    print("-" * 80)
    test_urgent_billing()
    print()
    
    # Test 2: Multiple emails
    print("\nTest 2: Multiple Email Scenarios")
    print("-" * 80)
    needs_approval = test_multiple_emails()
    print()
